    ...
    return (
        ...
        >
            <div className="flex flex-col md:flex-row bg-surface">
                ...
                {/* LEFT: ORDER SUMMARY */}
                <aside className="w-full md:w-[35%] bg-surface-container-lowest px-2 py-2 md:pe-3 md:ps-0 flex flex-col justify-between border-b md:border-b-0 md:border-r border-outline-variant/50 min-h-[480px]">
                        ...
                        <div>
                            ...
                            <div className="flex gap-2">
                                <input
                                    ...
                                    className="w-full bg-surface border border-outline-variant rounded-xl px-3 py-2.5 text-sm focus:border-primary focus:ring-1 outline-none uppercase placeholder:normal-case transition-all"
                                />
                                <button className="bg-primary/10 text-primary hover:bg-primary hover:text-white font-bold px-4 py-2.5 rounded-xl text-sm transition-all whitespace-nowrap">
                                    Áp dụng
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col gap-4 mt-6">
                        ...
                        {/* CTA Button */}
                        <button className="w-full bg-primary hover:bg-primary/90 text-white font-bold px-6 py-3.5 rounded-xl shadow-[0_4px_14px_rgba(39,94,84,0.25)] flex items-center justify-center gap-2 transition-all active:scale-95">
                            Hoàn tất thanh toán
                ...
                {/* RIGHT: FORM & PAYMENT */}
                <main className="w-full md:w-[65%] p-5 md:px-3 md:py-2 flex flex-col gap-8 overflow-y-auto max-h-[85vh]">
                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-1.5">
                                ...
                                <input className="w-full bg-white border border-outline-variant rounded-xl px-4 py-3 text-sm focus:border-primary focus:ring-1 outline-none transition-all" placeholder="Nguyễn Văn A" type="text" />
                            </div>
                            <div className="space-y-1.5">
                                <label className="text-xs font-bold uppercase tracking-wider text-outline px-1">SĐT (Zalo)</label>
                                <input className="w-full bg-white border border-outline-variant rounded-xl px-4 py-3 text-sm focus:border-primary focus:ring-1 outline-none transition-all" placeholder="0123456789" type="tel" />
                            </div>
                            <div className="md:col-span-2 space-y-1.5">
                                ...
                                <input className="w-full bg-white border border-outline-variant rounded-xl px-4 py-3 text-sm focus:border-primary focus:ring-1 outline-none transition-all" placeholder="nguyenvana@gmail.com" type="email" />
                    ...
                    {template?.price > 0 && (
                        <section>
                            ...
                            {/* 4 / 7 split: QR | Bank info */}
                            <div className="grid grid-cols-11 gap-4 items-stretch">

                                {/* QR: col-span-4 — light card, minimal padding */}
                                ...
                                <div className="col-span-11 xl:col-span-7 bg-gradient-to-br from-primary/5 to-surface-container-lowest border border-primary/20 rounded-2xl p-5 shadow-sm flex flex-col justify-center gap-3">
                                    ...
                                    <div className="flex justify-between items-center border-b border-outline-variant/50 pb-2.5">
                                        ...
                                        <span className="ext-xs font-bold text-on-surface bg-white px-3 py-1.5 rounded-lg border border-outline-variant/30">19037880201019</span>
                                    </div>
                                    <div className="flex justify-between items-center border-b border-outline-variant/50 pb-2.5">
